...
| 11 | Which order is "by type"? (found while writing the happy-path tests) | **Listed order:** phones mobile, home, work · addresses home, work, mailing | The order the admin form shows them; alphabetical would be arbitrary | suggested |
