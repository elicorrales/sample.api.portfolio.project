...
| 16 | Spec piece 2: user endpoints | Wrote the 6 user operations into the spec. I questioned the proposed 100-character name limit ("what's realistic?"), which led to 50 per field, plus character rules that don't block real names like José, O'Brien, or García-Fernández de la Torre. The name pattern was tested against sample names before acceptance. | [07](decisions/07-users.md#field-details-spec-piece-2) | [10](decisions/10-api-conventions.md#shared-components-spec-piece-1) |
