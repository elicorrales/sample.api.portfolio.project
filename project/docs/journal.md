...
| 15 | Spec piece 1: shared parts | Wrote the reusable parts every endpoint will reference: admin token, error format, paging, IDs, version header, standard error responses. Ran a spec linter (Redocly) to check the file against OpenAPI rules. | [10](decisions/10-api-conventions.md#shared-components-spec-piece-1) |
